...
info->speed=455;
   ...
   // g_signal_connect (GTK_TOOL_BUTTON(playButton), "clicked", (GCallback)start_game, NULL);
    pauseButton = GTK_WIDGET(gtk_builder_get_object (builder, "pause"));


    //g_signal_connect (GTK_TOOL_BUTTON(pauseButton), "clicked", (GCallback)pause_game, NULL);
   ...
   /*
   soon..
   rest= GTK_WIDGET(gtk_builder_get_object (builder, "restart"));
    g_signal_connect (GTK_TOOL_BUTTON(rest), "clicked", (GCallback)rest_game, NULL);
*/
